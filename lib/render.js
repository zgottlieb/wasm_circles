export default function initRender (pointer, circleFloat32Array, circleCount, init = () => {}, timeStep = () => {}) {
    ...
    init(pointer, displayWidth, displayHeight);
        console.log(circleFloat32Array);
    /*
    ...
    function draw () {
      ...
      for (let i = 0; i < iterations; i++)
        timeStep(pointer, displayWidth, displayHeight);
